...
- [Pythonic Application Architecture Patterns for Managing Complexity](https://github.com/python-leap/book) ★3292 - A Book about Pythonic Application Architecture Patterns for Managing Complexity.  Cosmos is the Opposite of Chaos you see. O'R. wouldn't actually let us call it "Cosmic Python" tho. [🐍, Other license].
...
- [python-dependency-injector](https://github.com/ets-labs/python-dependency-injector) ★3646 - Dependency injection framework for Python. [🐍, BSD 3-Clause "New" or "Revised" License].
- [returns](https://github.com/dry-python/returns) ★3343 - Make your functions return something meaningful, typed, and safe!. [🐍, BSD 2-Clause "Simplified" License].
- [Injector](https://github.com/alecthomas/injector) ★1224 - Python dependency injection framework, inspired by Guice. [🐍, BSD 3-Clause "New" or "Revised" License].
- [Inject](https://github.com/ivankorobkov/python-inject) ★664 - Python dependency injection. [🐍, Apache License 2.0].
...
- [Kink](https://github.com/kodemore/kink) ★350 - Dependency injection container made for Python. [🐍, MIT License].
- [Punq](https://github.com/bobthemighty/punq) ★283 - An IoC container for Python 3.6+. [🐍, MIT License].
- [di](https://github.com/adriangb/di) ★278 - Pythonic dependency injection. [🐍, MIT License].
- [svcs](https://github.com/hynek/svcs) ★246 - A Flexible Service Locator for Python. [🐍, MIT License].
...
- [Dishka](https://github.com/reagento/dishka) ★219 - Cute DI framework with agreeable API and everything you need. [🐍, Apache License 2.0].
- [Rodi](https://github.com/RobertoPrevato/rodi) ★159 - Implementation of dependency injection for Python 3. [🐍, MIT License].
...
- [Wireup](https://github.com/maldoinc/wireup) ★57 - Concise, Powerful, and Type-Safe Python Dependency Injection Library. [🐍, MIT License].
...
- [Flask-Injector](https://github.com/alecthomas/flask_injector) ★268 - Adds Injector support to Flask. [🐍, BSD 3-Clause "New" or "Revised" License].
- [svcs](https://github.com/hynek/svcs) ★246 - A Flexible Service Locator for Python. [🐍, MIT License].
- [Wireup](https://github.com/maldoinc/wireup) ★57 - Concise, Powerful, and Type-Safe Python Dependency Injection Library. [🐍, MIT License].
