...
- [Pythonic Application Architecture Patterns for Managing Complexity](https://github.com/python-leap/book) ★3734 - A Book about Pythonic Application Architecture Patterns for Managing Complexity.  Cosmos is the Opposite of Chaos you see. O'R. wouldn't actually let us call it "Cosmic Python" tho. [🐍, Other license].
...
- [python-dependency-injector](https://github.com/ets-labs/python-dependency-injector) ★4825 - Dependency injection framework for Python. [🐍, BSD 3-Clause "New" or "Revised" License].
- [returns](https://github.com/dry-python/returns) ★4235 - Make your functions return something meaningful, typed, and safe!. [🐍, BSD 2-Clause "Simplified" License].
- [Injector](https://github.com/alecthomas/injector) ★1511 - Python dependency injection framework, inspired by Guice. [🐍, BSD 3-Clause "New" or "Revised" License].
- [Dishka](https://github.com/reagento/dishka) ★1082 - Cute DI framework with agreeable API and everything you need. [🐍, Apache License 2.0].
- [Inject](https://github.com/ivankorobkov/python-inject) ★770 - Python dependency injection. [🐍, Apache License 2.0].
- [FastDepends](https://github.com/lancetnik/FastDepends) ★492 - FastAPI Dependency Injection system extracted from FastAPI and cleared of all HTTP logic. [🐍, MIT License].
- [Kink](https://github.com/kodemore/kink) ★438 - Dependency injection container made for Python. [🐍, MIT License].
- [Punq](https://github.com/bobthemighty/punq) ★417 - An IoC container for Python 3.6+. [🐍, MIT License].
- [svcs](https://github.com/hynek/svcs) ★400 - A Flexible Service Locator for Python. [🐍, MIT License].
- [Wireup](https://github.com/maldoinc/wireup) ★367 - Concise, Powerful, and Type-Safe Python Dependency Injection Library. [🐍, MIT License].
...
- [Rodi](https://github.com/RobertoPrevato/rodi) ★235 - Implementation of dependency injection for Python 3. [🐍, MIT License].
- [diwire](https://github.com/maksimzayats/diwire) ★216 - Type-safe dependency injection for Python with auto-wiring, scopes, async factories, and zero deps [🐍, MIT License].
- [python-injection](https://github.com/100nm/python-injection) ★125 - Dead-simple dependency injection framework for Python. [🐍, MIT License].
