...
- [Pythonic Application Architecture Patterns for Managing Complexity](https://github.com/python-leap/book) ★3729 - A Book about Pythonic Application Architecture Patterns for Managing Complexity.  Cosmos is the Opposite of Chaos you see. O'R. wouldn't actually let us call it "Cosmic Python" tho. [🐍, Other license].
...
- [python-dependency-injector](https://github.com/ets-labs/python-dependency-injector) ★4822 - Dependency injection framework for Python. [🐍, BSD 3-Clause "New" or "Revised" License].
- [returns](https://github.com/dry-python/returns) ★4232 - Make your functions return something meaningful, typed, and safe!. [🐍, BSD 2-Clause "Simplified" License].
...
- [Dishka](https://github.com/reagento/dishka) ★1072 - Cute DI framework with agreeable API and everything you need. [🐍, Apache License 2.0].
...
- [Punq](https://github.com/bobthemighty/punq) ★415 - An IoC container for Python 3.6+. [🐍, MIT License].
...
- [That Depends](https://github.com/modern-python/that-depends) ★243 - simple DI-framework, inspired by python-dependency-injector, but without wiring [🐍, MIT License].
- [Wireup](https://github.com/maldoinc/wireup) ★357 - Concise, Powerful, and Type-Safe Python Dependency Injection Library. [🐍, MIT License].
- [Rodi](https://github.com/RobertoPrevato/rodi) ★232 - Implementation of dependency injection for Python 3. [🐍, MIT License].
- [diwire](https://github.com/maksimzayats/diwire) ★209 - Type-safe dependency injection for Python with auto-wiring, scopes, async factories, and zero deps [🐍, MIT License].
...
- [Modern DI](https://github.com/modern-python/modern-di) ★49 - powerful DI-framework with scopes and IoC-container [🐍, MIT License].
...
- [Overlay](https://github.com/Atry/MIXINv2) ★0 - A dependency injection framework with pytest-fixture syntax, plus a configuration language for declarative programming [🐍, MIT License].
